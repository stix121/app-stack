...
const CustomersList = () => (
  <Card>
    <Card.Header>
      <Card.Title className="mb-0">Customers</Card.Title>
    </Card.Header>
    <Card.Body>
      <Table className="mb-0">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <Badge bg="" className="badge-subtle-success">
                Active
              </Badge>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <Badge bg="" className="badge-subtle-warning">
                Inactive
              </Badge>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <Badge bg="" className="badge-subtle-danger">
                Deleted
              </Badge>
            </td>
          </tr>
...
const Single = () => (
  <Card>
    ...
    <Card.Body>
      <Row className="g-0">
        <Col sm={3} xl={12} xxl={3} className="text-center">
          <img
            src={avatar3}
            width="64"
            height="64"
